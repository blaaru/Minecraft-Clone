...
/*
 * This is a Perlin Generator.
 * 
 * This was originally written in C#, converted in Java to be used in the Minecraft Clone.
 * 
 * All respects go toward Flafla2 and Ken Perlin.
...
public class Perlin {
    ...
    // Default constructor sets repeat to -1 (no repeat)
    public Perlin() {
        this(-1);
    }

    // Constructor with repeat parameter
    ...
    // Permutation table as defined by Ken Perlin; a randomly arranged array of numbers 0-255
    ...
    public double perlin(double x, double y, double z) {
        ...
        return (lerp(w, y1, y2) + 1) / 2;  // Normalize result to [0, 1]
    }
